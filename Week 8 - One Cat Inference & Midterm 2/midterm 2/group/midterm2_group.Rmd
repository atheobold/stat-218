...
```{r data-preview}
## Code to preview dataset goes here!
...
__3. Create a histogram visualizing the distribution of weights for this sample.__
...
__4. Using the favstats() function, find summary statistics for the weight for this sample.__

```{r weight-favstats}
favstats(____, data = YRBSS)
```

__5.  How many observations are we missing weights from?__
...
__6. Complete the code below to created faceted histograms of the distribution of weights between the two physically active groups.__
...
__7. Describe the relationship between the amount of exercise a high schooler gets and their weight. Is this the relationship you expected to see?__


### Summarizing the Differences in Mean Weight

__8. Use the favstats() function to find summary statistics for the weight for each group of the `physical_3plus` variable.__

```{r weight-favstats-groups}
favstats(____ ~ ____, data = YRBSS)
```

__9. What is the observed difference in mean weight between the "yes" and "no" groups?__



## Statistical Inference

__10.  Write the hypotheses for testing if the average weights for high schoolers who exercise at least three times are different from those who don't.__

*H0:* 

*HA:* 

__11. Evaluate if you believe any of the *three* conditions required for using the t-distribution to obtain our p-value are violated.__




__12. Complete the code below to find the p-value for testing if the average weights for high schoolers who exercise at least three times are different from those who don't.__
...
__13. Based on the p-value you obtained, what conclusion would you reach for the hypotheses you stated in #10?__
