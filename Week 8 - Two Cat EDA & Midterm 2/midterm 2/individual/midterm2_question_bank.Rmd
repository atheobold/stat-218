...
```{r tinytex-messages, include = FALSE}
...
\item With such a large p-value, we have insufficient evidence to reject the
null hypothesis. We conclude the true mean of the differences in glucose 
...
\begin{itemize}
\item The results of the hypothesis test and the confidence interval tend to 
...
\item The results of the hypothesis test and the confidence interval are
...
\item The results of the hypothesis test and the confidence interval seem to 
