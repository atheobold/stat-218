...
<!-- Simple question about conditions -->


\noindent
\textbf{(d)}[] Regarding the condition of normality condition, which data should
you be concerned about? Circle one. 

\begin{itemize}
\item the glucose data from the Placebo and the BPA trials \\
\item the within subject glucose differences \\
\item neither \\
\item both
\end{itemize}
