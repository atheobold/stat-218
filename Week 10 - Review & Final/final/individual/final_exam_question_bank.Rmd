...
\noindent \textbf{Q9} \textbf{For each of the following, select the single most appropriate analysis for the situation described. You may use an analysis for
...
\begin{enumerate}
\item Researchers are interested in investigating how
...
\item A study of honeybees looked at whether the
...
\item An attorney in Boston observes that some judges
...
\item Researchers are interested in determining if the 
...
\item You are interested in deciding if you should rent
...
\item Matchmaking data scientists are always
