...
the blanks below with one answer in each set of parentheses to correctly explain
how one sample on the null distribution was be created.  Blanks preceded by (#) should be filled in with a number, all other blanks should be filled in with the
...
conditions does Dr. Hagobian need to check before obtaining a p-value? Circle
all that apply. 
...
They used computer simulation to obtain the null distribution shown below. 
