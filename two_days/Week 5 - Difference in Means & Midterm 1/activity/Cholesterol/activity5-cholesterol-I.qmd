...
4. Report the observed mean cholesterol level for participants on the corn flake diet. *Use appropriate notation with an informative subscipt.*

\vspace{0.3in}

5. Report the observed mean cholesterol level for participants on the oat bran diet. *Use appropriate notation with an informative subscipt.*
