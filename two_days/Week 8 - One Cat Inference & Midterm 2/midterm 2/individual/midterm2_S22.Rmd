...
\large{Section (circle one):} \hspace{1cm} 2:10am \hspace{2cm} 4:10am 
...
Professor Robinson's STAT 218 class who has not yet taken the exam. The use of 
...
\noindent
\textbf{(f)} [2 pts] What is the value of the F-statistic?  
