...
For the Chi-Squared goodness-of-fit test we've been discussing, it can be mathematically shown that the distribution of $X^2$ statistics is approximately a $\chi^2$ (Chi-Squared) distribution with $k - 1$ degrees of freedom. Similar to an ANOVA, $k$ represents the number of groups in our explanatory variable.
...
|----------------|-------|--------------------------|
| Inner Burn     | 520   |                          |
| Inner Edge     | 210   | 210 / 3000 = 0.070       |
| Outer Edge     | 240   |                          |
| Outer Unburned | 2030 | 2030 / 3000 = 0.677      |

\vspace{0.25in}

These proportions comprise our null hypothesis! 
...
**19. Now, calculate the $X^2$ statistic for these data.** *Note: You will have four components you need to add together!*
