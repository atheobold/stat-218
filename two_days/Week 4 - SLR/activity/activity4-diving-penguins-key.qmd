...
```{r data, include = TRUE, echo = TRUE, messages = F, warnings = F}
...
**11. When you square small residuals what happens?** *Hint: What happens if you square a value between 0 and 1? What about a small value greater than 1?*
...
+ Response variable (choose `Duration` or `Dive_HeartRate`): \key{Duration}
