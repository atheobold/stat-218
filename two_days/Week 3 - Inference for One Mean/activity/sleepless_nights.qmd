...
__19. Do you believe that the 50 observations collected in this sample are 
independent? Why or why not?__

\vspace{2cm}

__20. Based on the histogram from yesterday's activity, do you believe it is
...
__21. How many degrees of freedom will we use for our $t$-distribution?__

\vspace{1cm}

__22. Compared to a $t$-distribution with 20 degrees of freedom, will your 
...
__23. Given the summary statistics above, calculate the estimated standard
deviation of the sampling distribution (standard error).__

\vspace{2cm}

Did you notice that $\frac{\sigma}{\sqrt{n}}$ (the standard deviation of our bootstrap sampling distribution) did not equal $s$ (the standard deviation of
our observed sample)? This is because the variability between **individuals’**
number of hours slept is **VERY** different from the variability between the
**average** number of hours slept across samples of people.
...
> **variability!**
> *See the observed sample distribution and the bootstrap sampling distribution with the same x scales below to compare.*
...
__24. We are interested in making a 95% confidence interval. Using the table
...
__25. Using your answers to questions 5 and 6, create a 95% confidence interval
for the mean hours slept for all STAT 218 students.__

\vspace{2cm}

__26. What do we hope is contained in this interval?__

\vspace{2cm}

__27. Do we know if the interval contains this value?__

\vspace{2cm}

__28. How do you interpret the interval you found?__
...
__29. Do you think a 90% confidence interval be wider or narrower than your 95%
confidence interval? Explain.__

\vspace{1cm}

__30. When you change from a 90% to a 95% confidence interval, which part of the
...
__31. How does the multiplier change from the 95% to the 90% confidence
...
__32. How would the center change for a 99% confidence interval compared to
the 90% interval?__

\vspace{2cm}

__33. How would the standard error change for a 99% confidence interval compared
to the 90% interval? Explain.__

\vspace{2cm}

__34. How would the 95% confidence interval change if you surveyed a much
...
__35. What confidence interval did you obtain yesterday? Is it similar to or
different from the interval you obtained today?__

\vspace{2cm}

__36. Why do you think your intervals were different / similar?__

\vspace{2cm}

# Generalizability

__37.	Think again about how the sample was selected from the population. Do you
