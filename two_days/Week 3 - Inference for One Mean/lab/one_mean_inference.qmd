...
__3. Use the favstats() function to obtain the point estimate for $\mu$. (to 3 decimal places)__
...
4. Fill in the blanks to create a histogram of the `hours` variable. When
specifying your `binwidth`, think about a reasonable starting point (e.g., 1
hour or 0.5 hours). Then, look at your histogram and see if your bins should be
smaller (it looks too chunky) or larger (it looks like toothpicks). 
...
**10. Interpret, in the context of these data, the 90% confidence interval you obtained.** 
...
**11. Based on your 90% confidence interval do you believe you would reject or fail to reject the null hypothesis?**
*Hint:* Look at the prompts in Canvas to guide your decision. 
...
**12. Based on the p-value what would you decide to do regarding your null hypothesis?**
*Hint:* Look at the prompts in Canvas to guide your decision. 


**13. Write a conclusion in the context of this study.**
*Hint:* Look at the prompts in Canvas to guide your decision. 
