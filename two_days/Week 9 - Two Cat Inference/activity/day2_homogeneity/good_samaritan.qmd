...
getting across campus (the condition was randomly assigned). On the way between
buildings, an actor pretending to be a homeless person in distress asked the
...
$\pi_{\underline{\hspace{0.5in}}}$: The true proportion of people who are in a
...
7. Based on the research question, what is an appropriate alternative
hypothesis?  
...
In the last activity, we learned how to add a second categorical variable into
our bar plot. We learned there are three orientations for bar plots with two 
