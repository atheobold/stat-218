...
![](images/IPEDS_Description.png) \### Identifying Observations & Variables
...
IPEDS <- read_csv(here::here("two_days", 
...
For our analysis, we will look at the retention rates for *only* the 4-year institutions. In the code below I'm filtering the dataset down to ony include 4-year institutions (eliminating 2-year institutions).
