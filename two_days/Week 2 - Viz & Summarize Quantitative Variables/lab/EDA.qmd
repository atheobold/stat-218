...
7.  Fill in the code below with (1) the name of the variable you want to plot, and (2) a nice x-axis label to use.
...
8.  Are there outliers present in the dataset? Describe where these outliers are located.
