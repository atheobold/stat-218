...
# STAT 218 Information {.tabset .tabset-fade}
...
- quiz questions
  ...
  + *Important*: Make sure you are receiving email notifications for any Canvas 
  activity. In Canvas, click on your name, then Notifications. Check that Canvas
  ...
  + If you have a question about the course materials, computing, or logistics,
  please post your question to your Canvas discussion board instead of emailing
  me! This ensures all students can benefit from the responses. Other students
...
Stat 218 will meet 4 times per week. Each week in STAT 218 will, for the most
part, look something like this:
...
* Video quizzes are due **Monday at 8pm Pacific Time each week**.
* The two lowest video grades will be dropped.

### Activities (10%)

Tuesday's and Thursday's classes will be dedicated to meeting with your
classmates and instructor to work through that day's group activity. Attendance
...
learned in the activities completed Tuesday, using R to explore and analyze 
data.  
...
* Video quizzes are due **Friday at 8pm Pacific Time each week**.
* The two lowest end of week quiz grades will be dropped.
...
* **If you miss more than 33% of class days within a unit without communicating
with your section instructor and group-mates, you must complete the group exam
individually.**

#### _Individual portion_:

<!-- Individual midterm exam will be: **February 18th** -->
...
solutions to the practice exam released in Canvas the Sunday prior to the exam.
Further details, resources, and instructions for each exam will be posted the
week prior to the exam in Canvas.
...
- **Section 07 (8:10am)** -- Wednesday, June 8, from 7:10am – 10:00am
- **Section 09 (9:10am)** -- Friday, June 10 from 7:10am – 10:00am
