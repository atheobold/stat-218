...
in mind the column totals and the row totals will stay the **same** (there were
only 34 people with limb injuries, and only 155 people who died). However, the
**cell values** will **change** (we won't always have 61 fatalities for body
injuries). 
