...
______________ (hurry or no hurry / help or no help) _______ (was / was not)  randomly ____________ (assigned / selected).
...
11. Fill out the table of expected values below. 
...
12. Using the formula above, calculate how far "off" each of the cells in our
observed table is from what was expected under the null hypothesis. 

\vspace{0.5in}


13. Adding all of these differences together to obtain our observed $X^2$
statistic. 
...
14. Based on your table of expected counts, which method should you use for 
...
15. How many degrees of freedom would be use for our $\chi^2$ distribution?
...
16. Using the values you calculated before, fill in the code below:
...
17. Based on this p-value what conclusion would you reach regarding the null
hypothesis?
...
18.  Write a paragraph summarizing the results of the study as if writing a press release.  Be sure to describe:
...
15. Calculate the $X^2$ statistic for this simulation. 
...
16. Draw a line where the observed $X^2$ statistic falls on this distribution.

\vspace{0.25in}

17. Estimate the p-value for testing if the proportion of students who helped
is the same between the two groups (hurry / no hurry). 

\vspace{0.25in}

18. Based on your p-value, what would you conclude for your null and alternative
hypotheses? (Look back at what you said for #11 and #12)!

\vspace{1in}

19.  Write a paragraph summarizing the results of the study as if writing a
