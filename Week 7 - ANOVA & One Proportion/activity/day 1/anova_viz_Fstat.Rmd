...
1. Answer the following questions about the boxplots above.
...
2. Report the mean budget amount for each rating.  Use appropriate notation.

\vspace{0.8in}

3. Which content ratings have the largest difference in their mean budget?
...
5. Which content rating has the smallest standard deviation?

\vspace{0.25in}

6. How many times larger is your answer in #4 than your answer in #5?

\vspace{0.8in}

7. Which content rating has the largest sample size? What is the formula for 
...
8. What does the read line across the entire plot represent?

\vspace{0.5in}

9. What do the blue lines across each group represent?
...
9. Draw vertical lines on the plot above, indicating which values are being
...
10. Draw vertical lines on the plot above, indicating which values are being
...
11. How many degrees of freedom does the `content_rating` variable have?
...
12. How many degrees of freedom does the SSE for our content rating analysis
have?
...
13. Can an F-statistic be negative?
...
14. What is the sum of squares for `content_rating`?

\vspace{0.25in}

15. What is the sum of squares for the errors?

\vspace{0.25in}

16. How was the mean squares for `content_rating` found?

\vspace{0.25in}

17. How was the mean squares for the errors found?

\vspace{0.25in}

18. What is the resulting F-statistic?

\vspace{0.25in}

19. Why is there an NA in the `statistic` column for the `Residuals`?
...
20. Based on the p-value associated with the F-statistic you found in #18, do 
you think this is a small F-statistic or a large F-statistic?

\vspace{0.5in}

21. Do you believe this statistic is likely to occur if the null hypothesis 
is true?
