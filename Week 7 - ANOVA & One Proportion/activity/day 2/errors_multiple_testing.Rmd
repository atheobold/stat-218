...
8. Which plots should we use to assess this condition, the side-by-side boxplots
or the faceted histograms? Why?
...
Let's revisit the boxplots that we first saw. It's entirely possible that in 
#5 you said that you didn't believe there were "substantial" difference across 
these groups. 

```{r boxplots-again, echo = FALSE, out.width = "70%"}
ggplot(data = GSS, 
       mapping = aes(x = number_of_hours_worked_last_week)
       ) +
  geom_histogram(binwidth = 10) + 
...
In a hypothesis test, there are two competing hypotheses: the null and the alternative. We make a statement about which one might be true, but we might 
