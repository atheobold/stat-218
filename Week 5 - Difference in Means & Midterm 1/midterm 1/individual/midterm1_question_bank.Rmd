...
\large{Your exam questions will be randomly selected from this bank of
...
```{r}
# Code to for temperature analysis
...
\noi {\bf (d)} [3 pts] Using the least squares line in part b, predict the
number of correct math problems for a participant in a room with a temperature
of 19.10 degrees Celsius. Be sure to include units on your answer.  If you did
not find an answer to part b, use $\hat{y} = 12.5 + 0.032x$.
...
temperature of  19.10 degrees Celsius and who had 15 correct math problems. Be
